...
il faut rajouter une couche d'embedding sur les roles genre on prend quand meme l'encoding positionnel au début et ensuite on met une couche d'embedding la dessus , potentiellement 
faire ca aussi sur les fillers je sais pas si ca a un intérêt
